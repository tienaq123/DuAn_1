              ...
              <form method="post" id="addToCartForm" class="btn_buy">
                ...
                ">
                  ...
                  <div style="display: flex">
                    <button style="width: 30px; height: 30px; border: none; cursor: pointer;" type="button" onclick="decreaseQuantity()">-</button>
                    <input id="productQuantityInput" name="product_quantity" style="
                          width: 30px;
                          font-size: 14px;
                          text-align: center;
                          border: none;
                        " type="number" class="no-spinners" value="1" readonly />
                    <button style="width: 30px; height: 30px; border: none; cursor: pointer;" type="button" onclick="increaseQuantity()">+</button>
                  </div>
                </div>
                ...
                <div class="btn-buy"><button type="submit" name="add_to_cart" value="add_to_cart" class="buy">Thêm vào giỏ hàng</button>
...
<?php
// Kiểm tra nếu người dùng click vào nút "Thêm vào giỏ hàng"
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_to_cart']) && $_POST['add_to_cart'] === 'add_to_cart') {
...
<script>
  // JavaScript để thay đổi giá trị số lượng
