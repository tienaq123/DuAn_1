<!DOCTYPE html>
<html lang="en">
  <!-- Mirrored from weblearnbd.net/tphtml/ebazer/customer-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 14 Jul 2023 14:34:50 GMT -->
  <head>
    <meta charset="UTF-8" />
      ...
      >
        ...
        <div class="body-content px-8 py-8 bg-slate-100">
          ...
          <div class="bg-white rounded-t-md rounded-b-md shadow-xs py-4">
            <div
              class="tp-search-box flex items-center justify-between px-8 py-8"
            >
              ...
              <div class="flex justify-end space-x-6">
                ...
                <div class="product-add-btn flex">
                  <a
                    href="#"
                    class="tp-btn bg-info/10 text-info hover:text-white hover:bg-theme"
                  >
                    <span class="mr-2">
                      <svg
                        width="15"
              ...
              <table class="w-full text-base text-left text-gray-500">
                <thead class="bg-white">
                  <tr class="border-b border-gray6 text-tiny">
                    ...
                    <th
                      scope="col"
                      class="pr-8 py-3 text-tiny text-text2 uppercase font-semibold w-[12%]"
                    >
                      ID
                    </th>
                    <th
                    ...
                    <th
                      scope="col"
                      class="px-3 py-3 text-tiny text-text2 uppercase font-semibold text-end"
                    >
                      Email
                    </th>
                    <th
                      scope="col"
                      class="px-3 py-3 text-tiny text-text2 uppercase font-semibold w-[200px] text-end"
                    >
                      Status
                    </th>
                    <th
                      scope="col"
                      class="px-3 py-3 text-tiny text-text2 uppercase font-semibold w-[250px] text-end"
                    >
                      Join Date
                    </th>
