    ...
    <div class="container clearfix">
      ...
      <div id="containerisotope" class="clear">
        ...
        ?>
            ...
            <!--element-->
            <div style="min-height: 420px; border: 1px solid #eaeaea;" class="element <?php echo trim($row['category_name']) ?> " data-category="<?php echo trim($row['category_name']) ?>">
              ...
              <a href="/Duan1/Pages/Detail/detail.php">
                ...
                <h2 style="font-family: 'Lobster Two', cursive; font-size: 18px; text-align: start; margin-left: 10px; min-height: 50px;"><?php echo trim($row['category_name']) ?></h2>
