...
<body>
    ...
    <div class="container clearfix">
      ...
      <div id="containerisotope" class="clear">
        ...
        ?>
            ...
            <!--element-->
            <div style="min-height: 420px; border: 1px solid #eaeaea;" id="productList" class="element blue" data-category="blue">
  ...
  <script>
    $(document).ready(function() {
      ...
      var productsPerPage = <?php echo $products_per_page ?>;

      // Function để load sản phẩm từ trang load_more_products.php
      function loadProducts() {
        $.ajax({
          ...
          success: function(response) {
            $('#containerisotope').append(response);
            currentPage++;
          },
          error: function() {
