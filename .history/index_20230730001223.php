...
<body>
        ...
        ?>
            ...
            <div style="min-height: 420px; border: 1px solid #eaeaea;" class="element <?php echo str_replace(' ', '', $row['category_name']) ?> " data-category="<?php echo str_replace(' ', '', $row['category_name']) ?>">
              ...
              <form method="post" id="addToCartForm">
                ...
                <button type="button" id="addToCartButton" name="add_to_cart" class="btn-cart" data-product-id="<?php echo $row['id'] ?>">
  ...
  //     'quantity' => $product_quantity // Bạn có thể thêm số lượng sản phẩm vào đây
  //   );
  ...
  <script>
    ...
    addToCartButtons.forEach(button => {
      button.addEventListener('click', function() {
        ...
        // Gửi yêu cầu Ajax đến trang xử lý
