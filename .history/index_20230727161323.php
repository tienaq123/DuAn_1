...
<body>
  ...
  <header id="navigationmenu">
    <a id="goCart" class="demo-blog" href="/Pages/cart/cart.php">
      <div class="count-cart">
    ...
    <div class="container clearfix">
      ...
      <!--start logo-->
      <a id="logo" href="/Duan1/Pages/Home_Page/index.php">
  ...
  <section id="testimonials">
    ...
    <div class="anchors">
      <div class="contanchors">
        ...
        <a href="#sectionportfolio"><img width="45" class="anchorbottom" alt="" src="img/anchors/bottomtestimonials.png" /></a>
      </div>
    </div>
    <!--end anchors-->
    ...
    <div class="container clearfix">
      ...
      <div id="containerisotope" class="clear">
        ...
        <div class="element blue" data-category="blue">
          <a data-rel="prettyPhoto[]" href="./Public/img/section-works/imgworks1.jpg">
        ...
        <!--element-->
        <div class="element blue" data-category="blue">
          <a data-rel="prettyPhoto[]" href="./Public/img/section-works/imgworks2.jpg">
        ...
        <!--element-->
        <div class="element blue" data-category="blue">
          <a data-rel="prettyPhoto[]" href="./Public/img/section-works/imgworks3.jpg">
        ...
        <!--element-->
        <div class="element blue" data-category="blue">
          <a data-rel="prettyPhoto[]" href="./Public/img/section-works/imgworks4.jpg">
        ...
        <!--element-->
        <div class="element blue" data-category="blue">
          <a data-rel="prettyPhoto[]" href="./Public/img/section-works/imgworks5.jpg">
