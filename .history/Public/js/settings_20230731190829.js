jQuery(function ($) {
  ...
  SWEET.map = function () {
    var map;
    var vietNam = new google.maps.LatLng(21.0206120940588, 105.76392461949965);
  ...
  SWEET.menu = function () {
    $("#navigationmenu, .contanchors, .backtotop").click(function (event) {
      ...
      if (trgt === "backtotop") {
        // Nếu người dùng click vào nút "Back to Top", cuộn mượt lên đầu trang
        $("html,body").animate({ scrollTop: 0 }, 900);
      } else {
        // Ngược lại, thực hiện cuộn đến vị trí của phần tử cần đến
