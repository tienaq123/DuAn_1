    ...
    <div class="container clearfix">
      ...
      <div id="containerisotope" class="clear">
        ...
        ?>
            ...
            <!--element-->
            <div style="min-height: 420px; border: 1px solid #eaeaea; display: flex;" class="element <?php echo str_replace(' ', '', $row['category_name']) ?> " data-category="<?php echo str_replace(' ', '', $row['category_name']) ?>">
              <div>
