    ...
    <div class="container clearfix">
      ...
      <div id="containerisotope" class="clear">
        ...
        ?>
            ...
            <!--element-->
            <div style="min-height: 420px;" class="element blue" data-category="blue">
              <a data-rel="prettyPhoto[]" href="<?php echo $row['thumbnail'] ?>">
                <img style="margin-top: 0;" alt="" class="imgwork" src="<?php echo $row['thumbnail'] ?>" />
              </a>
              <a style="font-family: 'Lobster Two', cursive; background-color: #f5f5f5; border: none; color: #7d7d7d; font-weight: bold;" href="/Duan1/Pages/Detail/detail.php">
                <h2 style="font-family: 'Lobster Two', cursive; font-size: 18px; text-align: start; margin-left: 10px;"><?php echo $row['title'] ?></h2>
                <p style="font-family: 'Lobster Two', cursive;"></p><?php echo number_format($row['price']) ?>đ</p>
              </a>
