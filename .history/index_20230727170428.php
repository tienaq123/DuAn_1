        ...
        <nav class="rightnavigation">
          <ul>
            ...
            if (isset($_SESSION['user_id'])) {
              ...
              echo "Welcome, $fullname!"; // Thay "Welcome" bằng chào mừng theo ngôn ngữ của bạn
              echo '<a href="logout.php">Logout</a>'; // Thay đường dẫn "logout.php" bằng file xử lý đăng xuất

            } else {
              echo '<li><a id="pageLogin" href="/Duan1/Pages/login/login.php">Login</a></li>'
      ...
      <div id="containerisotope" class="clear">
        ...
        <div class="element blue" data-category="blue">
          <a data-rel="prettyPhoto[]" href="./Public/img/section-works/imgworks1.jpg">
            <img alt="" class="imgwork" src="./Public/img/section-works/imgworks1.jpg" />
          </a>
        ...
        <div class="element blue" data-category="blue">
          <a data-rel="prettyPhoto[]" href="./Public/img/section-works/imgworks2.jpg">
            <img alt="" class="imgwork" src="./Public/img/section-works/imgworks2.jpg" />
          </a>
          <a href="/Duan1/Pages/Detail/detail.php">
            <h2>Đây là bánh ngọt cần bán</h2>
            <p>85.000đ</p>
        ...
        <div class="element blue" data-category="blue">
          <a data-rel="prettyPhoto[]" href="./Public/img/section-works/imgworks3.jpg">
            <img alt="" class="imgwork" src="./Public/img/section-works/imgworks3.jpg" />
          </a>
          <a href="/Duan1/Pages/Detail/detail.php">
            <h2>Đây là bánh ngọt cần bán</h2>
            <p>85.000đ</p>
        ...
        <div class="element blue" data-category="blue">
          <a data-rel="prettyPhoto[]" href="./Public/img/section-works/imgworks4.jpg">
            <img alt="" class="imgwork" src="./Public/img/section-works/imgworks4.jpg" />
          </a>
          <a href="/Duan1/Pages/Detail/detail.php">
            <h2>Đây là bánh ngọt cần bán</h2>
            <p>85.000đ</p>
        ...
        <div class="element blue" data-category="blue">
          <a data-rel="prettyPhoto[]" href="./Public/img/section-works/imgworks5.jpg">
            <img alt="" class="imgwork" src="./Public/img/section-works/imgworks5.jpg" />
          </a>
          <a href="/Duan1/Pages/Detail/detail.php">
            <h2>Đây là bánh ngọt cần bán</h2>
            <p>85.000đ</p>
