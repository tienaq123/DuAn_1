  ...
  <div class="container">
    ...
    <div class="form-login">
      ...
      <div class="form-box register">
        <h2 style="padding-top: 20px;">Registration</h2>
        <form action="#">
          <div class="input-box">
          ...
          <div style="padding-bottom: 20px;" class="login-register">
            <p>
...
if (isset($_POST["login_submit"])) {
  ...
  $sql = "INSERT INTO User (username, email, phone_number, address, password) 
            VALUES ('$username', '$email', '$phone_number', '$address', '$hashed_password')";

  if (mysqli_query($conn, $sql)) {
    // Nếu thêm thành công, chuyển hướng đến trang đăng nhập
