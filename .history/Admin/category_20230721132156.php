                  ...
                  <table class="w-full text-base text-left text-gray-500">
                    <thead>
                      <tr class="border-b border-gray6 text-tiny">
                        ...
                        <th scope="col" class="px-3 py-3 text-tiny text-text2 uppercase font-semibold w-[2000px]">
                          Name
                        </th>
                        <th scope="col"
                        ...
                        <th scope="col" class="px-9 py-3 text-tiny text-text2 uppercase font-semibold w-[15%] text-end">
                          Action
                        </th>
                      </tr>
                    </thead>
