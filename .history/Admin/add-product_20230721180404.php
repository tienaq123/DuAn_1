                      ...
                      <div class="col-span-12 xl:col-span-8 2xl:col-span-9">
                        <div class="mb-6 bg-white px-8 py-8 rounded-md">
                          ...
                          <div class="mb-5">
                            ...
                            <textarea style="width: 100%; border: 1px solid #ccc; border-radius: 6px;" name="" id="" cols="30" rows="10" name="description"></textarea>
                          </div>
                        </div>
                        ...
                        <div class="bg-white px-8 py-8 rounded-md mb-6">
                          ...
                          <div class=" gap-3 mb-5">
                            <div style="width: 100%" class="category-select select-bordered">
                              ...
                              <select style="width: 100%" name="old_price">
