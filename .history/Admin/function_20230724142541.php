...
function addProduct($conn, $productData)
{
    ...
    $sql = "INSERT INTO Product (title, description, price, old_price, thumbnail, category_id, created_at) VALUES ('$title', '$description', $price, $old_price, '$thumbnail', $category_id)";
