...
if (isset($_GET['keyword'])) {
  ...
  if (mysqli_num_rows($result) > 0) {
    while ($row = mysqli_fetch_assoc($result)) {
      ...
      echo '<span class="font-medium text-heading text-hover-primary transition">#' . $row['id'] . '</span>';
      echo '<span class="font-medium text-heading text-hover-primary transition">' . $row['fullname'] . '</span>';
      echo '<span class="font-medium text-heading text-hover-primary transition">' . $row['total_money'] . '</span>';
      echo '<span class="font-medium text-heading text-hover-primary transition">' . $row['status'] . '</span>';
      echo '</div>';
