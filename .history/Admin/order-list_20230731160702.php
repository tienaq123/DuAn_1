            ...
            <table class=" w-[1500px] 2xl:w-full text-base text-left text-gray-500 active-table">
              ...
              <tbody>
                ...
                $sql = "SELECT o.*, od.* FROM orders o
                  INNER JOIN orders od ON o.id = od.order_id";
                    ...
                    <td class="px-9 py-3 text-center">
                      <div class="flex items-center justify-end space-x-2">
                        <div class="relative" x-data="{ editTooltip: false }">
                          <a href="order-detail.php?order_id=<?php echo $row['order_id'] ?>">
                    ...
                    <td class="px-9 py-3 text-end">
                      <div class="flex items-center justify-end space-x-2">
                        ...
                        <div class="relative" x-data="{ viewTooltip: false }">
                          <a href="#" class="inline-block w-auto px-3 h-10 leading-10 text-tiny bg-gray text-black rounded-md hover:bg-theme hover:text-white" x-on:mouseenter="viewTooltip = true" x-on:mouseleave="viewTooltip = false">
