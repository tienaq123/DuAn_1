        ...
        <div class="bg-white rounded-t-md rounded-b-md shadow-xs py-4">
          <div class="tp-search-box flex items-center justify-between px-8 py-8 flex-wrap">
            <div class="search-input relative">
              <input class="input h-[44px] w-full pl-14" type="text" placeholder="Search by order id" />
            ...
            <table class="w-[1500px] 2xl:w-full text-base text-left text-gray-500">
              <thead class="bg-white">
                <tr class="border-b border-gray6 text-tiny">
                  ...
                  <th scope="col" class="px-9 py-3 text-tiny text-text2 uppercase font-semibold w-[14%] text-end">
                    Action
                  </th>
                  <th scope="col" class="px-9 py-3 text-tiny text-text2 uppercase font-semibold w-[4%] text-end">
                    Invoice
                  </th>
                </tr>
              </thead>
              ...
              <tbody>
                <tr class="bg-white border-b border-gray6 last:border-0 text-start mx-9">
                  ...
                  <td class="pr-8 py-5 whitespace-nowrap">
                    <a href="#" class="flex items-center space-x-5 text-hover-primary text-heading">
                      <img class="w-[50px] h-[50px] rounded-full" src="assets/img/users/user-10.jpg" alt="" />
                  ...
                  <td class="px-3 py-3 text-end">
                    <span class="text-[11px] text-success px-3 py-1 rounded-md leading-none bg-success/10 font-medium text-end">Delivered</span>
                  </td>
                  <td class="px-3 py-3 font-normal text-[#55585B] text-end">
                    16 Jan, 2023
                  </td>
                ...
                <tr class="bg-white border-b border-gray6 last:border-0 text-start mx-9">
                  ...
                  <td class="pr-8 py-5 whitespace-nowrap">
                    <a href="#" class="flex items-center space-x-5 text-hover-primary text-heading">
                      <img class="w-[50px] h-[50px] rounded-full" src="assets/img/users/user-8.jpg" alt="" />
                  ...
                  <td class="px-3 py-3 text-end">
                    <span class="text-[11px] text-danger px-3 py-1 rounded-md leading-none bg-danger/10 font-medium text-end">Denied</span>
                  </td>
                  <td class="px-3 py-3 font-normal text-[#55585B] text-end">
                    18 Feb, 2023
                  </td>
                  ...
                  <td class="px-9 py-3 text-end">
                    <div class="flex items-center justify-end space-x-2">
                      <div class="relative" x-data="{ editTooltip: false }">
                        <a href="order-details.html" class="w-auto px-3 h-10 leading-10 text-tiny bg-success text-white rounded-md hover:bg-green-600 inline-block" x-on:mouseenter="editTooltip = true" x-on:mouseleave="editTooltip = false">
                          View Details
                        </a>
                        <div x-show="editTooltip" class="flex flex-col items-center z-50 absolute left-1/2 -translate-x-1/2 bottom-full mb-1">
                          <span class="relative z-10 p-2 text-tiny leading-none font-medium text-white whitespace-no-wrap w-max bg-slate-800 rounded py-1 px-2 inline-block">Details</span>
                ...
                <tr class="bg-white border-b border-gray6 last:border-0 text-start mx-9">
                  ...
                  <td class="pr-8 py-5 whitespace-nowrap">
                    <a href="#" class="flex items-center space-x-5 text-hover-primary text-heading">
                      <img class="w-[50px] h-[50px] rounded-full" src="assets/img/users/user-7.jpg" alt="" />
                  ...
                  <td class="px-3 py-3 text-end">
                    <span class="text-[11px] text-indigo-500 px-3 py-1 rounded-md leading-none bg-indigo-100 font-medium text-end">Refunded</span>
                  </td>
                  <td class="px-3 py-3 font-normal text-[#55585B] text-end">
                    25 Jan, 2023
                  </td>
                ...
                <tr class="bg-white border-b border-gray6 last:border-0 text-start mx-9">
                  ...
                  <td class="pr-8 py-5 whitespace-nowrap">
                    <a href="#" class="flex items-center space-x-5 text-hover-primary text-heading">
                      <img class="w-[50px] h-[50px] rounded-full" src="assets/img/users/user-6.jpg" alt="" />
                ...
                <tr class="bg-white border-b border-gray6 last:border-0 text-start mx-9">
                  ...
                  <td class="pr-8 py-5 whitespace-nowrap">
                    <a href="#" class="flex items-center space-x-5 text-hover-primary text-heading">
                      <img class="w-[50px] h-[50px] rounded-full" src="assets/img/users/user-5.jpg" alt="" />
