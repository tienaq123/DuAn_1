                                                    ...
                                                    <td class="px-3 py-3">
                                                        <div class="flex items-center space-x-2">
                                                            <form action="" method="post">
                                                                ...
                                                                <input type="submit" name="update_role_btn" value="Update Role" class="bg-success hover:bg-green-600 text-white inline-block text-center leading-5 text-tiny font-medium pt-2 pb-[6px] px-4 rounded-md">
