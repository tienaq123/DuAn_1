                  ...
                  <table class="w-full text-base text-left text-gray-500">
                    <thead>
                      <tr class="border-b border-gray6 text-tiny">
                        ...
                        <th width="40%" scope="col" class="px-3 py-3 text-tiny text-text2 uppercase font-semibold w-[170px]">
                          Name
                        </th>
                        ...
                        <th width="20%" scope="col" class="px-9 py-3 text-tiny text-text2 uppercase font-semibold w-[13%] text-end">
                          Action
                        </th>
                      </tr>
                    </thead>
