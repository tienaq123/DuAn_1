                  ...
                  <tr class="bg-white border-b border-gray6 last:border-0 text-start mx-9">
                    ...
                    <td class="px-9 py-3 text-end">
                      <div class="flex items-center justify-end space-x-2">
                        <div class="relative text-end" x-data="{ editTooltip: false }">
                          <a href="order-detail.php?order_id=<?php echo $row['id'] ?>">
                            <button class="w-auto px-3 h-10 leading-10 text-tiny bg-success text-white rounded-md hover:bg-green-600 text-center" x-on:mouseenter="editTooltip = true" x-on:mouseleave="editTooltip = false">
                              View Details
                            </button>
                          </a>
