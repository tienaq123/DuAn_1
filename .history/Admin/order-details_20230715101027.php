  ...
  <div class="tp-main-wrapper bg-slate-100 h-screen" x-data="{ sideMenu: false }">
    ...
    <div class="tp-main-content lg:ml-[250px] xl:ml-[300px] w-[calc(100% - 300px)]" x-data="{ searchOverlay: false }">
      ...
      <div class="body-content px-8 py-8 bg-slate-100">
        ...
        <div class="">
          <div
            class="flex items-center flex-wrap justify-between px-8 mb-6 bg-white rounded-t-md rounded-b-md shadow-xs py-6">
            <div class="relative">
                  ...
                  <tbody>
                    <tr class="bg-white border-b border-gray6 last:border-0 text-start mx-9">
                      ...
                      <td class="py-3 whitespace-nowrap">
                        <a href="#"
                          class="flex items-center justify-end space-x-5 text-end text-heading text-hover-primary">
                          <img class="w-10 h-10 rounded-full" src="assets/img/users/user-10.jpg" alt="" />
                ...
                <table class="w-[400px] sm:w-full text-base text-left text-gray-500">
                  <tbody>
                    ...
                    <tr class="bg-white border-b border-gray6 last:border-0 text-start mx-9">
                      ...
                      <td class="py-3 text-end">
                        Online
                        <img class="w-[40px] h-auto" src="assets/img/icons/visa.svg" alt="" />
                      </td>
                    </tr>
                    <tr class="bg-white border-b border-gray6 last:border-0 text-start mx-9">
                      <td class="py-3 font-normal text-[#55585B] w-[50%]">
                ...
                <table class="w-[400px] sm:w-full text-base text-left text-gray-500">
                  <tbody>
                    ...
                    <tr class="bg-white border-b border-gray6 last:border-0 text-start mx-9">
                      ...
                      <td class="py-3 text-end">Texas</td>
                    </tr>
                  </tbody>
                </table>
              </div>
                      ...
                      <tr class="bg-white border-b border-gray6 last:border-0 text-start mx-9">
                        <td class="pr-8 py-5 whitespace-nowrap">
                          <a href="#" class="flex items-center space-x-5">
                            ...
                            <span class="font-medium text-heading text-hover-primary transition">Red Bag for kids</span>
                          </a>
                        </td>
                        <td class="px-3 py-3 font-normal text-[#55585B] text-end">
                          $15.00
                      ...
                      <tr class="bg-white border-b border-gray6 last:border-0 text-start mx-9">
                        <td class="pr-8 py-5 whitespace-nowrap">
                          <a href="#" class="flex items-center space-x-5">
                            ...
                            <span class="font-medium text-heading text-hover-primary transition">Sports shoe for
                              women</span>
                          </a>
                        </td>
                        <td class="px-3 py-3 font-normal text-[#55585B] text-end">
