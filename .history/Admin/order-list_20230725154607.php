            ...
            <table class="w-[1500px] 2xl:w-full text-base text-left text-gray-500">
              <thead class="bg-white">
                <tr class="border-b border-gray6 text-tiny">
                  ...
                  <th scope="col" class="px-9 py-3 text-tiny text-text2 uppercase font-semibold w-[14%]">
                    Action
                  </th>
                  <th scope="col" class="px-9 py-3 text-tiny text-text2 uppercase font-semibold w-[4%]">
                    Invoice
                  </th>
                </tr>
              </thead>
