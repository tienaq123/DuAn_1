                            ...
                            <td class="px-9 py-3 text-end">
                              <div class="flex items-center justify-end space-x-2">
                                ...
                                if (isset($_POST['delete_category']) && isset($_POST['csrf_token']) && $_POST['csrf_token'] === $_SESSION['csrf_token']) {
                                  ...
                                  // Thực thi truy vấn
                                  if (mysqli_query($conn, $sql)) {
                                    // Nếu xóa thành công, bạn có thể thiết lập biến trạng thái thành true
                                    $delete_success = true;
                                  } else {
                                ...
                                <!-- Trường hợp hiển thị thông báo sau khi xóa thành công -->
                                <?php if (isset($delete_success) && $delete_success) { ?>
                                  <div class="alert alert-success">Xóa danh mục thành công!</div>
                                <?php } ?>

                                <!-- Biểu mẫu và danh sách danh mục -->
                                <!-- ... -->

                                <!-- Nút để quay lại trang danh mục -->
                                <a href="http://localhost/Duan1/Admin/category.php" class="btn btn-primary">Quay lại danh mục</a>
