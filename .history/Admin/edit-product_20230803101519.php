                                            ...
                                            <div class="col-span-12 xl:col-span-8 2xl:col-span-9">
                                                <div class="mb-6 bg-white px-8 py-8 rounded-md">
                                                    ...
                                                    <div class="mb-5">
                                                        ...
                                                        <input class="input w-full h-[44px] rounded-md border border-gray6 px-6 text-base" type="text" placeholder="Product name" name="title" value="<?php echo $product['title']; ?>" required>
                                                        <span class="text-tiny">A product name is required and recommended to be
                                                            unique.</span>
                                                    </div>
                                                    <div class="mb-5">
                                                        <p class="mb-0 text-base text-black">Description</p>
                                                        <textarea style="width: 100%; border: 1px solid #ccc; border-radius: 6px;" id="" cols="30" rows="10" name="description" value="" required><?php echo $product['description']; ?></textarea>
                                                    </div>
                                                </div>
                                                <div class="bg-white px-8 py-8 rounded-md mb-6">
                                                    ...
                                                    <div class="grid sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-x-6">
                                                        <div class="mb-5">
                                                            ...
                                                            <input class="input w-full h-[44px] rounded-md border border-gray6 px-6 text-base" type="number" placeholder="Product price" name="price" value="<?php echo $product['price']; ?>">
                                                        ...
                                                        <div class="mb-5">
                                                            ...
                                                            <input class="input w-full h-[44px] rounded-md border border-gray6 px-6 text-base" type="number" placeholder="Old price product" name="old_price" value="<?php echo $product['old_price']; ?>">
                                            ...
                                            <div class="col-span-12 xl:col-span-4 2xl:col-span-3">
                                                <div class="bg-white px-8 py-8 rounded-md mb-6">
                                                    ...
                                                    <div>
                                                        ...
                                                        <input class="input w-full h-[44px] rounded-md border border-gray6 px-6 text-base" type="text" placeholder="Link image" name="thumbnail" value="<?php echo $product['thumbnail']; ?>">
                                                    </div>
                                                </div>
                                                <div class="bg-white px-8 py-8 rounded-md mb-6">
