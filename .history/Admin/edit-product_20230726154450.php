                                            ...
                                            <div class="col-span-12 xl:col-span-8 2xl:col-span-9">
                                                <div class="mb-6 bg-white px-8 py-8 rounded-md">
                                                    ...
                                                    <div class="mb-5">
                                                        ...
                                                        <input class="input w-full h-[44px] rounded-md border border-gray6 px-6 text-base" type="text" placeholder="Product name" name="product_name" value="<?php echo $product['title']; ?>">
