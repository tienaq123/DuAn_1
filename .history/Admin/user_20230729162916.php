                        ...
                        <div class="">
                            <div class="relative rounded-b-md bg-white px-10 py-7">
                                ...
                                <table class="w-full text-base text-left text-gray-500">
                                    ...
                                    FROM user u
                                    LEFT JOIN role r ON u.role_id = r.id WHERE deleted = 0";
                                                ...
                                                <tr class="bg-white border-b border-gray6 last:border-0 text-start">
                                                    ...
                                                    <td class="px-3 py-3">
                                                        <div class="flex items-center space-x-2">
                                                            ...
                                                            ?>
                                                            <form action="delete_item.php?action=delete_user" method="post">
                                                                <input type="hidden" name="user_id" value="<?php echo $user_id ?>">
                                                                <button type="submit" name="delete_user" class="bg-white text-slate-700 border border-slate-200 hover:bg-danger hover:border-danger hover:text-white inline-block text-center leading-5 text-tiny font-medium pt-[6px] pb-[5px] px-4 rounded-md">
                                                                    <span class="text-[9px] inline-block -translate-y-[1px] mr-[1px]">
