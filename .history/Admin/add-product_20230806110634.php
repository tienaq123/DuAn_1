                      ...
                      <div class="col-span-12 xl:col-span-8 2xl:col-span-9">
                        <div class="mb-6 bg-white px-8 py-8 rounded-md">
                          ...
                          <div class="mb-5">
                            ...
                            <input required class="input w-full h-[44px] rounded-md border border-gray6 px-6 text-base" type="text" placeholder="Product name" name="product_name" />
                        ...
                        <div class="bg-white px-8 py-8 rounded-md mb-6">
                          ...
                          <div class="grid sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-x-6">
                            <div class="mb-5">
                              ...
                              <input required class="input w-full h-[44px] rounded-md border border-gray6 px-6 text-base" type="number" placeholder="Product price" name="price" />
                      ...
                      <div class="col-span-12 xl:col-span-4 2xl:col-span-3">
                        <div class="bg-white px-8 py-8 rounded-md mb-6">
                          ...
                          <div>
                            ...
                            <input required class="input w-full h-[44px] rounded-md border border-gray6 px-6 text-base" type="text" placeholder="Link image" name="thumbnail" />
                          </div>
                        </div>
                        <div class="bg-white px-8 py-8 rounded-md mb-6">
