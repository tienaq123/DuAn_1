                        ...
                        <div class="">
                            <div class="relative rounded-b-md bg-white px-10 py-7">
                                ...
                                <table class="w-full text-base text-left text-gray-500">
                                    ...
                                    <?php
                                    $sql = "SELECT u.id, u.fullname, u.email, u.phone_number, u.address, u.created_at, r.name AS role_name
                                    FROM user u
                                                        ...
                                                        <div class="flex items-center space-x-2">
                                                            <form action="" method="post">
                                                                ...
                                                                <button class="bg-success hover:bg-green-600 text-white inline-block text-center leading-5 text-tiny font-medium pt-2 pb-[6px] px-4 rounded-md">
                                                                    ...
                                                                    <input type="submit" name="update_role_btn" value="Update Role">
                                                                </button>
                                                            </form>
                                                            <?php
                                                            // Kết nối đến cơ sở dữ liệu (có thể cần thêm mã PHP khác để kết nối)
                                                            ...
                                                            if (isset($_POST['update_role_btn'])) {
                                                                ...
                                                                $query_select_role = "SELECT role_id FROM Users WHERE id = $userId";
                                                                ...
                                                                if ($result_select_role) {
                                                                    ...
                                                                    $query_update_role = "UPDATE Users SET role_id = $newRole WHERE id = $userId";
                                                                    ...
                                                                    // Lỗi trong quá trình truy vấn role_id hiện tại
