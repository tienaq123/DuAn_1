          ...
          <ul>
            ...
            <li class="hidden">
              ...
              <ul x-show="nav == 3" class="pl-[42px] pr-[20px] pb-3">
                ...
                <li>
                  <a href="#" class="block font-normal w-full text-[#6D6F71] hover:text-theme nav-dot">Customer Details</a>
                </li>
              </ul>
            </li>
            <li>
              <a @click="nav !== 4 ? nav = 4 : nav = null" :class="nav == 4 ? 'bg-themeLight hover:bg-themeLight text-theme' : ''" href="javascript:void(0);" class="group rounded-md relative text-black text-lg font-medium inline-flex items-center w-full transition-colors ease-in-out duration-300 px-5 py-[9px] mb-3 hover:bg-gray sidebar-link-active">
                <span class="inline-block translate-y-[1px] mr-[10px] text-xl">
                  <svg class="-translate-y-[4px]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16">
              ...
              <ul x-show="nav == 4" class="pl-[42px] pr-[20px] pb-3">
                <li>
                  <a href="order-list.html" class="block font-normal w-full text-[#6D6F71] hover:text-theme nav-dot">Orders List</a>
                </li>
                <li>
                  <a href="order-details.html" class="block font-normal w-full text-[#6D6F71] hover:text-theme nav-dot">Order Details</a>
                </li>
                <li>
                  <a href="transaction.html" class="block font-normal w-full text-[#6D6F71] hover:text-theme nav-dot">Transactions</a>
                </li>
              </ul>
            </li>
            <li>
      ...
      <div class="body-content px-8 py-8 bg-slate-100">
        <div class="flex justify-between mb-10">
          <div class="page-title">
            <h3 class="mb-0 text-[28px]">Customer</h3>
        ...
        <div class="bg-white rounded-t-md rounded-b-md shadow-xs py-4">
          <div class="tp-search-box flex items-center justify-between px-8 py-8">
            ...
            <div class="flex justify-end space-x-6">
              ...
              <div class="product-add-btn flex">
                <a href="#" class="tp-btn">Add Customer</a>
              </div>
            </div>
          </div>
            ...
            <table class="w-full text-base text-left text-gray-500">
              ...
              <tbody>
                <tr class="bg-white border-b border-gray6 last:border-0 text-start mx-9">
                  ...
                  <td class="px-3 py-3 text-end">support@mail.com</td>
                ...
                <tr class="bg-white border-b border-gray6 last:border-0 text-start mx-9">
                  ...
                  <td class="pr-8 py-5 whitespace-nowrap">
                    <div class="flex items-center space-x-5 text-heading">
                      <img class="w-[40px] h-[40px] rounded-md" src="assets/img/users/user-9.jpg" alt="" />
                      <span class="font-medium">Steve Smith</span>
                    </div>
                  </td>

                  <td class="px-3 py-3 text-end">smith@mail.com</td>
                  <td class="px-3 py-3 text-end">
                    <span class="text-[11px] text-danger px-3 py-1 rounded-md leading-none bg-danger/10 font-medium text-end">Banned</span>
                  </td>
                  <td class="px-3 py-3 font-normal text-[#55585B] text-end">
                ...
                <tr class="bg-white border-b border-gray6 last:border-0 text-start mx-9">
                  ...
                  <td class="pr-8 py-5 whitespace-nowrap">
                    <div class="flex items-center space-x-5 text-heading">
                      <img class="w-[40px] h-[40px] rounded-md" src="assets/img/users/user-8.jpg" alt="" />
                      <span class="font-medium">Jenny Cris</span>
                    </div>
                  </td>

                  <td class="px-3 py-3 text-end">jenny@support.com</td>
                  <td class="px-3 py-3 text-end">
                    <span class="text-[11px] text-info px-3 py-1 rounded-md leading-none bg-info/10 font-medium text-end">On Hold</span>
                  </td>
                  <td class="px-3 py-3 font-normal text-[#55585B] text-end">
                    Feb 10, 2023 05:40 PM
                  </td>
                ...
                <tr class="bg-white border-b border-gray6 last:border-0 text-start mx-9">
                  ...
                  <td class="pr-8 py-5 whitespace-nowrap">
                    <div class="flex items-center space-x-5 text-heading">
                      <img class="w-[40px] h-[40px] rounded-md" src="assets/img/users/user-7.jpg" alt="" />
                      <span class="font-medium">Hems Wory</span>
                    </div>
                  </td>

                  <td class="px-3 py-3 text-end">hems@support.com</td>
                  <td class="px-3 py-3 text-end">
                    <span class="text-[11px] text-success px-3 py-1 rounded-md leading-none bg-success/10 font-medium text-end">Active</span>
                  </td>
                  <td class="px-3 py-3 font-normal text-[#55585B] text-end">
                    Feb 15, 2023 07:55 PM
                  </td>
                ...
                <tr class="bg-white border-b border-gray6 last:border-0 text-start mx-9">
                  ...
                  <td class="pr-8 py-5 whitespace-nowrap">
                    <div class="flex items-center space-x-5 text-heading">
                      <img class="w-[40px] h-[40px] rounded-md" src="assets/img/users/user-6.jpg" alt="" />
                      <span class="font-medium">Billy Wills</span>
                    </div>
                  </td>

                  <td class="px-3 py-3 text-end">billy@support.com</td>
                  <td class="px-3 py-3 text-end">
                    <span class="text-[11px] text-success px-3 py-1 rounded-md leading-none bg-success/10 font-medium text-end">Active</span>
                  </td>
                  <td class="px-3 py-3 font-normal text-[#55585B] text-end">
                    Feb 25, 2023 10:45 PM
                  </td>
                ...
                <tr class="bg-white border-b border-gray6 last:border-0 text-start mx-9">
                  ...
                  <td class="pr-8 py-5 whitespace-nowrap">
                    <div class="flex items-center space-x-5 text-heading">
                      <img class="w-[40px] h-[40px] rounded-md" src="assets/img/users/user-5.jpg" alt="" />
                      <span class="font-medium">Tommy Hilfing</span>
                    </div>
                  </td>

                  <td class="px-3 py-3 text-end">tommy@support.com</td>
                  <td class="px-3 py-3 text-end">
                    <span class="text-[11px] text-warning px-3 py-1 rounded-md leading-none bg-warning/10 font-medium text-end">Pending</span>
                  </td>
                  <td class="px-3 py-3 font-normal text-[#55585B] text-end">
                    Feb 28, 2023 04:01 AM
                  </td>
...
<!-- Mirrored from weblearnbd.net/tphtml/ebazer/customer-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 14 Jul 2023 14:34:51 GMT -->
