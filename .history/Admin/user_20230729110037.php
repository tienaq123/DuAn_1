                            ...
                            <div class="relative rounded-b-md bg-white px-10 py-7">
                                ...
                                <table class="w-full text-base text-left text-gray-500">
                                    ...
                                    ?>
                                        ...
                                        // Kết nối với cơ sở dữ liệu (đảm bảo bạn đã thực hiện kết nối)
                                        // $conn là biến kết nối CSDL
                                        ...
                                        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                                            ...
                                            // Kiểm tra nếu role_id đang là 1 thì sửa thành 2, nếu đang là 2 thì sửa thành 1
                                            $new_role_id = ($role_id === 1) ? 2 : 1;

                                            // Cập nhật role_id trong cơ sở dữ liệu
                                            $query_update = "UPDATE users SET role_id = $new_role_id WHERE id = $user_id";
