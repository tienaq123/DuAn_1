<header id="navigationmenu">
    <a id="goCart" class="demo-blog" href="/Duan1/Pages/cart/cart.html">
    ...
    <div class="container clearfix">
      ...
      <!--start logo-->
      <a href="/Duan1/Pages/Home_Page/index.html">
      ...
      <div class="grid_5">
        <nav class="rightnavigation">
          <ul>
            ...
            <!--you can edit-->
            <li><a id="pageLogin" href="/Duan1/Pages/login/login.html">Login</a></li>
            <!--you can edit-->
          </ul>
        </nav>
      </div>
