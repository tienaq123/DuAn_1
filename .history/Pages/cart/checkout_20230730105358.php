  ...
  <main id="main">
    <div class="container">
      <div class="directional" style="text-align: center">
        ...
        <span>
          <a href="http://127.0.0.1:5500/cart/cart.html">Giỏ hàng</a>
        </span>
      ...
      <div class="checkout">
        <form action="">
            ...
            <!-- <div class="form-check">
                <label class="form-check-label">
                  ...
                  <p>
                    ...
                    <a href="/chinhsachbanhang-n53878.html"
          ...
          <div class="payment">
            ...
            <input type="radio" name="paymentMethod" value="cashOnDelivery" onclick="togglePaymentForm(false)"
              checked />
