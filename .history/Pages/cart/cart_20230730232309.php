...
<body>
                    ...
                    <div class="text-quantity">
                      <div style="display: flex">
                        ...
                        <input id="quantityInput-<?php echo $item['id']; ?>" style="
                          ...
                          text-align: center;
                          border: none;
                        " type="number" class="no-spinners" value="<?php echo  intval($item['quantity']) ?>" onchange="updateCartQuantity('<?php echo  intval($item['id']); ?>', this.value)" />
                        <button style="width: 30px; height: 30px; border: none; cursor: pointer;" onclick="updateCartQuantity('<?php echo  intval($item['id']); ?>', this.value)">
                          +
                        </button>
  ...
  <script>
    ...
    function updateQuantity(productId, quantityChange) {
      ...
      xhr.send('update_quantity=true&product_id=' + encodeURIComponent(productId) + '&new_quantity=' + encodeURIComponent(quantityChange));
    }
  </script>
