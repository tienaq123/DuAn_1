        ...
        <form method="post" action="">
          ...
          if (isset($_POST['submit'])) {
            ...
            $sql = "INSERT INTO Orders (user_id, fullname, email, phone_number, address, note, order_date, status, total_money)
                    VALUES ('$user_id','$hoTen', '$email', '$dienThoai', '$diaChiChiTiet', '$ghiChu', NOW(), 'Pending', '$cart_total')";
            ...
            if ($conn->query($sql) === true) {
              ...
              // Sau khi lưu đơn hàng thành công, có thể xóa giỏ hàng trong session
              unset($_SESSION['cart']);
            ...
            <div class="formCode form-group">
              ...
              <div class="input-group">
                ...
                <div class="input-group-btn">
                  <button class="btn btn-pink" id="getCoupon" type="disabled" disabled>
                    Áp dụng
                  </button>
                </div>
              </div>
          ...
          <div class="payment">
            ...
            <!-- <input type="hidden" name="paymentMethod" value="creditCard" onclick="togglePaymentForm(true)" />
            ...
            <input type="submit" name="submit" value="Hoàn tất thanh toán" />
          </div>
        </form>
      </div>
    </div>
