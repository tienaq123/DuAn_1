                  ...
                  <div class="cart_products-text">
                    ...
                    <div class="text-quantity">
                      <div style="display: flex">
                        ...
                        <?php echo intval($item['quantity']) + 1; ?>
                        <input style="
                          width: 30px;
                          font-size: 14px;
                          text-align: center;
                        ...
                        <button style="width: 30px; height: 30px; border: none; cursor: pointer;" onclick="updateQuantity('<?php echo $item['id']; ?>', <?php echo intval($item['quantity']) + 1; ?>)">
                          +
                        </button>
