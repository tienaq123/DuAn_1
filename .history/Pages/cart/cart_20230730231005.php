                  ...
                  <div class="cart_products-text">
                    ...
                    <div class="text-quantity">
                      <div style="display: flex">
                        <button style="width: 30px; height: 30px; border: none; cursor: pointer;" onclick="updateCartQuantity('<?php echo $item['id']; ?>', -1)">
                          -
                        </button>
                        <input id="quantityInput-<?php echo $item['id']; ?>" style="
                          ...
                          text-align: center;
                          border: none;
                        " type="number" class="no-spinners" value="<?php echo $item['quantity'] ?>" onchange="updateCartQuantity('<?php echo $item['id']; ?>', this.value)" />
                        <button style="width: 30px; height: 30px; border: none; cursor: pointer;" onclick="updateCartQuantity('<?php echo $item['id']; ?>', 1)">
                          +
                        </button>
