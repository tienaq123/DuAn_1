                    ...
                    <div class="text-quantity">
                      <div style="display: flex">
                        ...
                        <input id="quantityInput-<?php echo $item['id']; ?>" style="
                          ...
                          text-align: center;
                          border: none;
                        " type="number" class="no-spinners" value="<?php echo  intval($item['quantity']) ?>" onchange="updateCartQuantity('<?php echo  intval($item['id']); ?>', this.value)" data-productId="<?php echo $item['id']; ?>" />
                        <button style="width: 30px; height: 30px; border: none; cursor: pointer;">
                          +
                        </button>
