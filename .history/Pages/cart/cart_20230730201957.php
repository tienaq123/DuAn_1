          ...
          ?>
              ...
              <div class="cart_products-item">
                ...
                <div class="cart_products-right">
                  <button class="delete-product-btn" data-product-id=""><i class="bx bx-x"></i></button>
                  <!-- <i class="bx bx-x delete-product-btn" data-product-id="<?php echo $item['id'] ?>"></i> -->
      ...
      button.addEventListener('click', function() {
        ...
        xhr.onreadystatechange = function() {
          if (xhr.readyState === XMLHttpRequest.DONE) {
            if (xhr.status === 200) {
              // Xử lý kết quả trả về nếu cần thiết (ví dụ: cập nhật lại giỏ hàng trên trang)
              // Ví dụ: window.location.reload(); // Tải lại trang sau khi xóa sản phẩm thành công
            } else {
              // Xử lý lỗi nếu có
