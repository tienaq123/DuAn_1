          ...
          ?>
              ...
              <div class="cart_products-item">
                ...
                <div class="cart_products-right">
                  ...
                  <button class="delete-product-btn" data-product-id="<?php echo $item['id'] ?>"><i class="bx bx-x delete-product-btn" data-product-id="<?php echo $item['id'] ?>"></i></button> <!-- Button delete -->
