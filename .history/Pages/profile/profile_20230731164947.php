                ...
                <div class="">
                  <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div class="mb-5">
                      ...
                      <input class="input w-full h-[49px] rounded-md border border-gray6 px-6 text-base text-black" type="text" id="fullname" name="fullname" value="<?php echo $_SESSION["username"]; ?>" />
                    </div>
                  </div>
                  ...
                  <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div class="mb-5">
                      ...
                      <input class="input w-full h-[49px] rounded-md border border-gray6 px-6 text-base text-black" type="number" id="number_phone" name="number_phone" value="<?php echo $_SESSION["phone_number"]; ?>" />
                    </div>
                  </div>
                  <div class="mb-5">
                    <p class="mb-0 text-base text-black">Address</p>
                    <textarea class="input w-full h-[200px] py-4 rounded-md border border-gray6 px-6 text-base resize-none text-black" id="address" name="address" value="<?php echo $_SESSION["address"]; ?>"><?php echo $_SESSION["address"]; ?></textarea>
                  </div>
              ...
              <div class="py-10 px-10 bg-white rounded-md">
                ...
                <div class="">
                  <div class="mb-5">
                    ...
                    <input class="input w-full h-[49px] rounded-md border border-gray6 px-6 text-base text-black" type="password" placeholder="Current Passowrd" value="" />
                  </div>
                  <div class="mb-5">
                    <p class="mb-0 text-base text-black">New Passowrd</p>
                    <input class="input w-full h-[49px] rounded-md border border-gray6 px-6 text-base text-black" type="password" placeholder="New Password" value="" />
                  </div>
                  <div class="mb-5">
                    <p class="mb-0 text-base text-black">Confirm Passowrd</p>
                    <input class="input w-full h-[49px] rounded-md border border-gray6 px-6 text-base text-black" type="password" placeholder="Confirm Password" value="" />
                  </div>
                  <div class="text-end mt-5">
